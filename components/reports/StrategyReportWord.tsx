  ...
  sections.push({
    ...
    children: [
      ...
      new Paragraph({
        children: [
          new TextRun({
            text: `${clientName || reportData.clientName ? `${clientName || reportData.clientName} • ` : ''}${new Date(reportData.generatedAt).toLocaleDateString('en-US', {
              year: 'numeric',
              month: 'short',
              day: 'numeric',
            })}${userName ? ` • Produced by: ${userName}` : ''} • Generated by Nytro.ai`,
            size: 20,
            color: '6b7280',
            italics: true,
          }),
