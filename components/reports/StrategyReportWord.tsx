  ...
  sections.push({
    ...
    children: [
      ...
      new Paragraph({
        children: [
          new TextRun({
            text: `${clientName || reportData.clientName || 'Client'} Content Library Analysis`,
            size: 28,
            color: '6b7280',
          }),
        ],
      ...
      new Paragraph({
        children: [
          new TextRun({
            text: `Account: ${clientName || reportData.clientName || 'Client'}`,
            size: 24,
            color: '374151',
          }),
        ],
    ...
    sections.push({
      ...
      children: [
        new Paragraph({
          children: [
            new TextRun({
              text: 'Asset Inventory - By ICP Target',
              bold: true,
              size: 36,
              color: 'F96E11',
            }),
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: 'Complete listing of all assets organized by Ideal Customer Profile (ICP) target, including Title, Function, Seniority, and Pain Clusters',
              size: 24,
              color: '374151',
              italics: true,
            }),
        ...
        ...icpEntries.flatMap(([icpTarget, assets]) => [
          new Paragraph({
            text: icpTarget,
            heading: HeadingLevel.HEADING_2,
            spacing: { before: 200, after: 200 },
                    ...
                    new TableCell({
                      children: [
                        new Paragraph({
                          children: [
                            new TextRun({
                              text: asset.painClusters.length > 0 ? asset.painClusters.join(', ') : '—',
                            }),
                          ],
                        }),
                      ],
    ...
    sections.push({
      ...
      children: [
        new Paragraph({
          children: [
            new TextRun({
              text: 'Asset Inventory - By Pain Cluster',
              bold: true,
              size: 36,
              color: 'F96E11',
            }),
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: 'Complete listing of all assets organized by Pain Cluster, including Title, Function, Seniority, and ICP Targets',
              size: 24,
              color: '374151',
              italics: true,
            }),
        ...
        ...painClusterEntries.flatMap(([painCluster, assets]) => [
          new Paragraph({
            text: painCluster,
            heading: HeadingLevel.HEADING_2,
            spacing: { before: 200, after: 200 },
                    ...
                    new TableCell({
                      children: [
                        new Paragraph({
                          children: [
                            new TextRun({
                              text: asset.icpTargets.length > 0 ? asset.icpTargets.join(', ') : '—',
                            }),
                          ],
                        }),
                      ],
